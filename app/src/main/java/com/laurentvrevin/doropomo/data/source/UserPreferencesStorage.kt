...
class UserPreferencesStorage(context: Context) {
    ...
    companion object {
        ...
        private const val FOCUS_MODE_KEY = "focus_mode_key"
    ...
    fun getUserPreferences(): UserPreferences {
        return UserPreferences(
            ...
            isFocusModeEnabled = sharedPreferences.getBoolean(FOCUS_MODE_KEY, false)
        )
    }
    ...
    fun saveUserPreferences(preferences: UserPreferences) {
        sharedPreferences.edit()
            ...
            .putBoolean(FOCUS_MODE_KEY, preferences.isFocusModeEnabled)
            .apply()
    }
}